...
public class ExceptionHandling {
    ...
    private static final String ACCOUNT_DISABLED = "Your account has been disabled. Please contact the administration.";
    ...
    public ResponseEntity<HttpResponse> MethoException() {
